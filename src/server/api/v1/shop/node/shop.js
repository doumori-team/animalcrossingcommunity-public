...
async function shop({id})
{
    ...
    const nodePermissionGranted = await this.query('v1/node/permission', {permission: 'read', nodeId: id});
    ...
    const [shop, customers, order, application] = await Promise.all([
        ...
        `, id, shopNode.shop_id),
        shopNode.order_id ? this.query('v1/shop/thread', {id: shopNode.order_id, category: constants.shops.categories.orders}) : null,
