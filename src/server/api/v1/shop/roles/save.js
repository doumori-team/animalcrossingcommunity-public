...
async function save({shopId, user, action, roles})
{
	...
	const currentUser = await this.query('v1/user_lite', {id: this.userId});
	...
	const shopUserId = await db.transaction(async query =>
	{
