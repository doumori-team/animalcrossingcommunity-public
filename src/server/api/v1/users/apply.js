 ...
 */
async function apply({groupId, text, format, username})
{
	const permissionGranted = await this.query('v1/permission', {permission: 'apply-nominate-staff'});
	...
	return { _success: `Your nomination / application has been submitted.` };
}
