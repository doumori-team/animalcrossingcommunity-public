...
async function support_tickets({page, username, userTicketId, status})
{
	const permissionGranted = await this.query('v1/permission', {permission: 'process-support-tickets'});
