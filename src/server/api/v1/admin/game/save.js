...
async function save({id, gameConsoleId, name, shortName, pattern, placeholder, sequence, isEnabled})
{
	const permission = await this.query('v1/permission', {permission: 'games-admin'});
