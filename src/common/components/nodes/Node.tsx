...
}: NodeProps) =>
{
	...
	if (displaying.user && user != null && 'group' in user)
	{
	...
	return (
		<article className={className} id={String(id)} key={id}>
			{(displaying.user && user != null && 'signature' in user) &&
			...
			<div className='Node_main'>
				{displaying.title &&
					...
					<div className='Node_titleLine'>
						<h1 className='Node_title'>
							{(displaying.breadcrumb && breadcrumb != null) &&
				...
				{(displaying.content && content != null) &&
				...
				{(displaying.signature && user != null && 'signature' in user) &&
