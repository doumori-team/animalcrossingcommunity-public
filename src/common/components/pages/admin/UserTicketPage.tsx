...
const UserTicketPage = () =>
{
	...
	const [actionId, setActionId] = useState<UserTicketActionType['id']>(noActionAction != null ? noActionAction.id : 0);
				...
				<UserContext.Consumer>
					{user => user && (
						...
						<div className='UserTicketPage_info'>
							...
							{(userTicket.reportedUsers != null && userTicket.reportedUsers.length > 1) && (
								<div className='UserTicketPage_submitted'>
									All Submitters
									<ul>
										...
										<RequireClientJS fallback={
											...
											>
												...
												<HTMLPurify
													...
													html={rule != null ? rule.description : ''}
													key={Math.random()}
												/>

												{(rule != null && rule.violations.length > 0) && (
													<Form.Group>
