...
{
	const {boards, acgames} = useLoaderData();

	const [latestEmail, setLatestEmail] = useState(null);

	const updateLatestEmail = (data) =>
	{
		setLatestEmail(data);
	}
			...
			<RequireUser>
				<div className='AutomationPage'>
					...
					<Section>
						...
						<div className='AutomationPage_sectionOption'>
							<Form
								action='v1/automation/other/fetch_email'
								showButton
								buttonText='Fetch Latest Email'
							/>
							...
							<Form
								...
								updateFunction={updateLatestEmail}
							/>
