...
const TunesPage = () =>
{
	const {totalCount, tunes, page, name, creator, pageSize} = useLoaderData();
...
export async function loadData(_, {page, name, creator})
{
	const returnValue = await this.query('v1/tunes', {
		page: page ? page : 1,
		name: name ? name : '',
