        ...
        <section className='Town'>
            <RequireUser id={userId} silent permission='modify-towns'>
                <div className='Town_links'>
                    ...
                    />
                    {(game.id === constants.gameIds.ACNH && mapDesignData != null && mapDesignData.dataUrl.length === 0) &&
            ...
            {(mapTiles.length > 0 || (mapDesignData != null && mapDesignData.dataUrl.length > 0)) && (
                <div className={`Town_map Town_map_${game.identifier}`}>
                    {(game.id === constants.gameIds.ACNH && mapDesignData != null) ? (
                        <img
            ...
            <InnerSection>
                ...
                <ul>
                    ...
                    {(game.id === constants.gameIds.ACNH && hemisphere != null) && (
