...
import CatalogCategory from '@/components/users/CatalogCategory.js';
import { Form, Text, Button } from '@form';
import { ErrorMessage, Section, SelectAllCheckbox } from '@layout';
import { catalogShape, catalogItemsShape, catalogCategoriesShape } from '@propTypes';

const Catalog = ({catalogItems, catalog, characterId, sortBy, userId,
	selectedCategory, name, catalogCategories, begLink, saveAction}) =>
{
...
Catalog.propTypes = {
	...
	catalog: PropTypes.arrayOf(catalogShape),
	characterId: PropTypes.number,
	sortBy: PropTypes.string,
	userId: PropTypes.number,
	selectedCategory: PropTypes.string,
	catalogCategories: PropTypes.arrayOf(catalogCategoriesShape),
	name: PropTypes.string,
	begLink: PropTypes.string,
