...
const PARSERS = {
	...
	[TOKENS.LINK_END]: () => '</a>',
	[TOKENS.COLOUR_START]: (_, color) => `<font color="${color}">`,
	...
	[TOKENS.CODE_END]: () => '',
	// EMOTES START
	[TOKENS.SMILE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SMILE); },
	[TOKENS.FROWNING_FACE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.FROWNING_FACE); },
	[TOKENS.GRIN]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.GRIN); },
	[TOKENS.SMILING_FACE_WITH_TWO_HEARTS]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SMILING_FACE_WITH_TWO_HEARTS); },
	[TOKENS.SHIFTY]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SHIFTY); },
	[TOKENS.SUNGLASSES]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SUNGLASSES); },
	[TOKENS.SMILING_IMP]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SMILING_IMP); },
	[TOKENS.STUCK_OUT_TONGUE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.STUCK_OUT_TONGUE); },
	[TOKENS.RAGE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.RAGE); },
	[TOKENS.LAUGHING]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.LAUGHING); },
	[TOKENS.WINK]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.WINK); },
	[TOKENS.BLUSH]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.BLUSH); },
	[TOKENS.CRY]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.CRY); },
	[TOKENS.CONFUSED]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.CONFUSED); },
	[TOKENS.ASTONISHED]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.ASTONISHED); },
	[TOKENS.NEUTRAL_FACE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.NEUTRAL_FACE); },
	[TOKENS.NAUSEATED_FACE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.NAUSEATED_FACE); },
	[TOKENS.ROLL_EYES]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.ROLL_EYES); },
	[TOKENS.RESETTI]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.RESETTI); },
	[TOKENS.BLANCA]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.BLANCA); },
	[TOKENS.GYROID]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.GYROID); },
	[TOKENS.SERENA]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SERENA); },
	[TOKENS.KK]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.KK); },
	[TOKENS.NAT]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.NAT); },
	[TOKENS.OWNER]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.OWNER); },
	[TOKENS.ADMIN]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.ADMIN); },
	[TOKENS.MOD]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.MOD); },
	[TOKENS.SCOUT]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.SCOUT); },
	[TOKENS.RESEARCHER]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.RESEARCHER); },
	[TOKENS.DEV]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.DEV); },
	[TOKENS.HC]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.HC); },
	[TOKENS.BIRTHDAY]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.BIRTHDAY); },
	[TOKENS.NEWBIE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.NEWBIE); },
	[TOKENS.BUDDY]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.BUDDY); },
	[TOKENS.UNFLAG]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.UNFLAG); },
	[TOKENS.FLAG]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.FLAG); },
	[TOKENS.EDIT]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.EDIT); },
	[TOKENS.MESSAGE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.MESSAGE); },
	[TOKENS.REPORT]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.REPORT); },
	[TOKENS.IDEA]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.IDEA); },
	[TOKENS.TRADE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.TRADE); },
	[TOKENS.WIFI]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.WIFI); },
	[TOKENS.LOCK]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.LOCK); },
	[TOKENS.STICKY]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.STICKY); },
	[TOKENS.HELP_BUTTON]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.HELP_BUTTON); },
	[TOKENS.FEEDBACK_POSITIVE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.FEEDBACK_POSITIVE); },
	[TOKENS.FEEDBACK_NEGATIVE]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.FEEDBACK_NEGATIVE); },
	[TOKENS.FEEDBACK_NEUTRAL]: function () { return getEmojiSrc(this.emojiSettings, TOKENS.FEEDBACK_NEUTRAL); },
}
...
function *lexer(text)
{
	...
	for (var i = 0; i < text.length; i++)
	{
		...
		for (const token of Object.values(TOKENS))
		{
			...
			if (matches)
			{
				let endIsNonWordChar = null, lastCharacter = '';

				if (token === TOKENS.USER_TAG)
				{
					lastCharacter = stringAt(unmatched, -1);
					endIsNonWordChar = lastCharacter.match(/\W/g);
				...
				if (PAIRED_TAGS.indexOf(token) > -1)
				{
				...
				if (TAG_PAIRINGS.get(token))
				{
					const unclosedStartTags = tokenCount[TAG_PAIRINGS.get(token)];

					// If there isn't, insert one.
					if (unclosedStartTags === 0 || isNaN(unclosedStartTags))
					{
						yield [TAG_PAIRINGS.get(token), ''];
					}
					// If there is, decrement the count of unmatched start tags.
					else
					{
						tokenCount[TAG_PAIRINGS.get(token)]--;
					}
				}
	...
	{
		for (let i = 0; i < tokenCount[TAG_PAIRINGS.get(token)]; i++)
		{
			yield [token, ''];
		}
	}
...
function getEmojiSrc(emojiSettings, markup)
{
...
export default function parser(input, options, html = false)
{
	...
	{
		output.push(PARSERS[token] ? PARSERS[token].apply(options, matches) : (html ? matches[0] : escapeHtml(matches[0])));
	}
